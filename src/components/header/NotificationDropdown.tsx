...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative">
      <button
        className="relative dropdown-toggle flex items-center justify-center text-white/70 transition-colors bg-brand-500 border border-brand-400 rounded-full h-11 w-11 hover:bg-brand-400 hover:text-white"
        onClick={handleClick}
      >
        <span
      ...
      <Dropdown
       ...
       className="!fixed !inset-x-4 mt-[17px] flex h-[480px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:!inset-x-auto sm:!right-0 sm:w-[361px]"
      >
