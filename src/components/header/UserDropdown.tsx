...
function toggleDropdown(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 border-2 border-white/30">
          <Image
            width={44}
            height={44}
        ...
        <span className="block mr-1 font-medium text-theme-sm text-white">Administrador</span>
