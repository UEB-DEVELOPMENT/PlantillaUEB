  ...
  return (
    <header className="sticky top-0 flex w-full bg-brand-500 border-brand-600 z-99999 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6 border-b-2 border-error-500">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-brand-600 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border border-brand-400 bg-brand-600 py-2.5 pl-12 pr-14 text-sm text-white shadow-theme-xs placeholder:text-white/50 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-white/10 xl:w-[430px]"
                />
